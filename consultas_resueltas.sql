/*
 * PROYECTO DE ANÁLISIS DE DATOS - VIDEOCLUB
 * Archivo: consultas_resueltas.sql
 * Descripción: Soluciones a las 64 cuestiones de negocio planteadas.
 */

--------------------------------------------------------------------------------
-- DATA PROJECT: LÓGICA CONSULTAS SQL 1
--------------------------------------------------------------------------------

-- 1. Crea el esquema de la BBDD.
-- (Este paso se realiza ejecutando el archivo BBDD_Proyecto.sql, no requiere query aquí)
...
--------------------------------------------------------------------------------
-- DATA PROJECT: LÓGICA CONSULTAS SQL 2
--------------------------------------------------------------------------------
...
SELECT AVG(return_date - rental_date) as media_alquiler_real 
FROM rental;
...
SELECT DATE(rental_date) as fecha, COUNT(*) as cantidad 
FROM rental 
...
SELECT EXTRACT(YEAR FROM rental_date) as anio, EXTRACT(MONTH FROM rental_date) as mes, COUNT(*) as total
FROM rental
GROUP BY anio, mes
ORDER BY anio, mes;
...
--------------------------------------------------------------------------------
-- DATA PROJECT: LÓGICA CONSULTAS SQL 3
--------------------------------------------------------------------------------
...
-- Contestación: No aporta valor para análisis directo. Genera un producto cartesiano (todas las películas combinadas con todas las categorías).
...
--------------------------------------------------------------------------------
-- DATA PROJECT: LÓGICA CONSULTAS SQL 4
--------------------------------------------------------------------------------
